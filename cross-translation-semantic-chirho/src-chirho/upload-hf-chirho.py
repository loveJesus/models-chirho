...
"""Upload cross-translation semantic model and dataset to HuggingFace Hub."""
...
def upload_chirho():
    ...
    model_dir_chirho = PROJECT_DIR_CHIRHO / "models-chirho" / "embedder-chirho" / "best-chirho"
    if model_dir_chirho.exists():
        repo_id_chirho = "LoveJesus/biblical-cross-translation-chirho"
        ...
        api_chirho.upload_folder(
            ...
            commit_message="Upload cross-translation embedding model",
        )
        card_path_chirho = PROJECT_DIR_CHIRHO / "cards-chirho" / "embedder-card-chirho.md"
    ...
    # Upload dataset
    dataset_repo_chirho = "LoveJesus/biblical-embedding-dataset-chirho"
    ...
    if data_dir_chirho.exists():
        ...
        api_chirho.upload_folder(
            ...
            repo_type="dataset",
            commit_message="Upload cross-translation embedding dataset",
        )
